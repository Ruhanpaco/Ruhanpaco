...
I started building websites at **9 years old** and have been exploring technology ever since. Today I work across **web, mobile, backend, cloud, APIs, automation, embedded systems, IoT, and open source**.
...
An open-source access-control project built around **ESP32**, exploring interoperability between modern digital-key and smart-home ecosystems.

**Working with:**

`Aliro` `Matter` `ESP32` `NFC` `MQTT` `Apple Home Key` `Samsung Home Key` `Google Home` `Home Assistant`

<a href="https://github.com/Ruhanpaco/Aliro-homekey">View Project →</a>
...
`ESP32` · `NFC` · `RFID` · `MQTT` · `Matter` · `Aliro` · `Home Assistant` · `APIs` · `Cloud Infrastructure` · `Automation` · `Open Source` · `Embedded C/C++`

The fun part is usually the thing sitting between two systems that were never designed to work together.
...
If you're building something interesting, working on open source, experimenting with hardware, or want to collaborate on a technical project, feel free to reach out.

<div align="center">

[![Discord](https://img.shields.io/badge/Discord-5865F2?style=for-the-badge&logo=discord&logoColor=white)](https://discord.com/users/1288952856136908894)
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0A66C2?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/ruhan-pacolli/)
[![Instagram](https://img.shields.io/badge/Instagram-E4405F?style=for-the-badge&logo=instagram&logoColor=white)](https://www.instagram.com/ruhan.paco/)
[![X](https://img.shields.io/badge/X-000000?style=for-the-badge&logo=x&logoColor=white)](https://x.com/Ruhanpaco)
